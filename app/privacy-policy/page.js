...
export const metadata = {
  ...
  description:
    "UrduCoder ki Privacy Policy — janein hum kya information collect karte hain aur kaise istemal karte hain.",
};

export default function PrivacyPolicyPage() {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="May 2, 2026">
      <p>
        UrduCoder (&quot;us&quot;, &quot;we&quot;, ya &quot;our&quot;) operates the website
        urducoder.com (the &quot;Site&quot;). This page informs you of our policies regarding the
      ...
      <ul>
        <li>
          <strong>Personal Data:</strong> While using our Site, we may ask you to provide certain
          personally identifiable information that can be used to contact or identify you. This
          may include your email address, name, and IP address.
        </li>
        <li>
          <strong>Usage Data:</strong> We may also collect information that your browser sends
          whenever you visit our Site (&quot;Usage Data&quot;). This data may include your computer&apos;s
          IP address, browser type, browser version, the pages of our Site that you visit, the
          time and date of your visit, time spent on those pages, and other diagnostic data.
        </li>
        <li>
      ...
      <h2>3. Google AdSense &amp; DoubleClick DART Cookie</h2>
      <p>
        ...
        <a href="https://www.urducoder.com" target="_blank" rel="noopener noreferrer">
          www.urducoder.com
        </a>{" "}
      ...
      <p>
        Our Site may include advertisements served by third parties such as Google AdSense and
        Adsterra. These advertisers may use cookies and web beacons to collect non-personally
        identifiable information about your visits to this and other websites in order to
        provide advertisements about goods and services that may interest you.
      </p>
      <p>
      ...
      <p>
        ...
        advertisements and links that appear on UrduCoder which are sent directly to your browser.
        They automatically receive your IP address when this occurs. Other technologies (such as
        cookies, JavaScript, or Web Beacons) may also be used by our site&apos;s third-party ad
        networks to measure the effectiveness of their advertisements and/or to personalize the
        advertising content that you see.
      </p>
      <p>
        UrduCoder has no access to or control over these cookies that are used by third-party
        advertisers.
      </p>

      <h2>5. Use of Data</h2>
      <p>UrduCoder uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        UrduCoder does not knowingly collect any Personal Identifiable Information from children
      ...
      <p>
        ...
        UrduCoder. This policy is not applicable to any information collected offline or via
      ...
      <ul>
        ...
        <li><strong>The right to data portability</strong> – You have the right to request that we transfer the data to another organization, or directly to you.</li>
      </ul>
